...
(function (global) {
  ...
  var DEFAULT_KEY = 'ryza.longmem.v1';
  var KEY = DEFAULT_KEY;
  var TEXT_MAX = 2000;
  ...
  var Memory = {
    ...
    /* Scope memory to one character (companion-chat engine). Flushes nothing:
       the previous character's state was persisted on every write. */
    bind: function (charId) {
      KEY = charId ? 'cc.' + String(charId) + '.longmem' : DEFAULT_KEY;
      load();
    },
    boundKey: function () { return KEY; }
  };
